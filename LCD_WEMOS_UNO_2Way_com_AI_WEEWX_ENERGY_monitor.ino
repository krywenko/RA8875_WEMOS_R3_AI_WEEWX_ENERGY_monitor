...
//int Tset;
//AI#######################
String TIME = "One Moment";
String TIME_C = "One Moment";
String DATE ="";
String DATE_C ="";
String STATION;
String STATION_C;
...
if (tft.touched()){//easy!
      ...
      if (ty >= 210 && ty <= 255){ //interface area
        if ((tx > 10 && tx < 50)){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("DOWN");
        tft.setFontScale(0);
        Serial3.println("cmd_100(0-2)");
        delay(200);
        }
         else if (tx >200  && tx <290 ){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(" UP ");
        tft.setFontScale(0);
        Serial3.println("cmd_100(1-2)");
          delay(200);
        }
      }
      if (ty >= 270 && ty <= 295){ //interface area
        if ((tx > 10 && tx < 50)){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("DOWN");
        tft.setFontScale(0);
        Serial3.println("cmd_100(0-3)");
        delay(200);
        }
         else if (tx >200  && tx <290 ){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(" UP ");
        tft.setFontScale(0);
        Serial3.println("cmd_100(1-3)");
          delay(200);
        }
      }
      if (ty >= 330 && ty <= 350){ //interface area
        if ((tx > 10 && tx < 50)){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("DOWN");
        tft.setFontScale(0);
        Serial3.println("cmd_100(0-4)");
        delay(200);
        }
         else if (tx >200  && tx <290 ){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(" UP ");
        tft.setFontScale(0);
        Serial3.println("cmd_100(1-4)");
          delay(200);
        }
      }
}
...
if (tft.touched()){//easy!
      ...
      if (ty >= 150 && ty <= 175){ //interface area
        if ((tx > 10 && tx < 50)){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("DOWN");
        tft.setFontScale(0);
        Serial3.println("cmd_100(0-5)");
        delay(200);
        }
         else if (tx >200  && tx <290 ){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(" UP ");
        tft.setFontScale(0);
        Serial3.println("cmd_100(1-5)");
          delay(200);
        }
      }
      if (ty >= 210 && ty <= 255){ //interface area
        if ((tx > 10 && tx < 50)){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("DOWN");
        tft.setFontScale(0);
        Serial3.println("cmd_100(0-6)");
        delay(200);
        }
         else if (tx >200  && tx <290 ){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(" UP ");
        tft.setFontScale(0);
        Serial3.println("cmd_100(1-6)");
          delay(200);
        }
      }
      if (ty >= 270 && ty <= 295){ //interface area
        if ((tx > 10 && tx < 50)){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("DOWN");
        tft.setFontScale(0);
        Serial3.println("cmd_100(0-7)");
        delay(200);
        }
         else if (tx >200  && tx <290 ){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(" UP ");
        tft.setFontScale(0);
        Serial3.println("cmd_100(1-7)");
          delay(200);
        }
      }
      if (ty >= 330 && ty <= 350){ //interface area
        if ((tx > 10 && tx < 50)){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("DOWN");
        tft.setFontScale(0);
        Serial3.println("cmd_100(0-8)");
        delay(200);
        }
         else if (tx >200  && tx <290 ){
         tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(100, 115);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(" UP ");
        tft.setFontScale(0);
        Serial3.println("cmd_100(1-8)");
          delay(200);
        }
      }
}
...
tft.ringMeter(input2,-40,40,xpos,ypos,radius,"none",4,tft.htmlTo565(0x848482),110,10);
 }
...
if (part1 == "39")
    ...
    float input = part2.toFloat();
    raw_CMD=input;
    //tft.setFontScale(1);tft.setCursor(150, 25);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("HeatIndex:");tft.setCursor(350, 25);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print(raw_CMD);
...
if (part1 == "40")
    ...
    float input = part2.toFloat();
    raw_CMD=input;
    tft.setFontScale(1);tft.setCursor(150, 2);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("WindChill:");tft.setCursor(340, 2);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(raw_CMD);
  }
  if (part1 == "41")
    {
   ...
   int raw_CMD;
    float input = part2.toFloat();
    raw_CMD=input;
    tft.setFontScale(1);tft.setCursor(150, 40);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("Humidex:");tft.setCursor(340, 40);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(raw_CMD);
...
if (part1 == "42")
  ...
  if (part1 == "43")
    ...
    float input = part2.toFloat();
    raw_CMD=input;;
    tft.setFontScale(1);tft.setCursor(150, 80);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print("Wind Speed:");tft.setCursor(340, 80);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(raw_CMD);
...
///////////Graphing Charts///////////
  ...
  if (millis() - runTime >= 1550L) { // Execute every 1s
    runTime = millis();
        ...
        x=scan;
     y = ext2;  
     Graph(tft, x, y, 320, 440, 460, 300, 0, Time, Tinc, 0, 10000, 1000, "kw", "hrs", "Solar/Grid", DKBLUE, RED, GREEN, WHITE, BLACK, graph_3);
     y= ext1;
     Graph2(tft, x, y, 320, 440, 460, 300, 0, Time, Tinc2, 0, 10000, 1000, "kw", "hrs", "", DKBLUE, RED, YELLOW, WHITE, BLACK, graph_4);
...
void AI_song(String Song){
   tft.setFontScale(0);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(430, 85);tft.setTextColor(RA8875_BLACK, RA8875_BLACK);tft.print(SONG_C);
   tft.setFontScale(0);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(430, 85);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.print(Song);
   SONG_C=Song;
}

void AI_station(String Station){
  tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(430, 52);tft.setTextColor(RA8875_BLACK, RA8875_BLACK);tft.print(STATION_C);
  tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(430, 52);tft.setTextColor(RA8875_RED, RA8875_BLACK);tft.print(Station);
  STATION_C=Station;
}

void  AI_META(String Artist){
  
  tft.setFontScale(0);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(430, 105);tft.setTextColor(RA8875_BLACK, RA8875_BLACK);tft.print(ARTIST_C);
  tft.setFontScale(0);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(430, 105);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print(Artist);
  ARTIST_C=Artist;
}

void AI_time(String Time){
 tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(530, 21);tft.setTextColor(RA8875_BLACK, RA8875_BLACK);tft.print(TIME_C);
 tft.setFontScale(1);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(530, 21);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print(Time);
   TIME_C=Time;
...
if (Screen ==1){ 
 tft.drawRoundRect(425,0,360,128,15,RA8875_GREEN); 
 tft.drawRoundRect(424,1,360,126,15,RA8875_GREEN);
 tft.drawRoundRect(423,2,360,124,15,RA8875_GREEN);
...
void AI_listen(){
if (Screen ==1){ 
 tft.drawRoundRect(425,0,360,128,15,RA8875_CYAN); 
 tft.drawRoundRect(424,1,360,126,15,RA8875_CYAN);
 tft.drawRoundRect(423,2,360,124,15,RA8875_CYAN);
AI_time(TIME);
//tft.setFontScale(0);tft.setTextColor(RA8875_YELLOW, RA8875_BLACK);tft.setCursor(430, 5);tft.setTextColor(RA8875_CYAN, RA8875_BLACK);tft.print(TIME);
