...
if (input45 == topic){
 ...
 Serial.println("cmd_45(0)");// Serial.print(inString); Serial.println(")"); 
} 
//---reseved for later use 
...
if (input46 == topic){
 String inString = "";
  ...
  Serial.println("cmd_46(1)"); //Serial.print(inString); Serial.println(")");
  }
if (input47 == topic){
 String inString = "";
  for (int i=0;i<length;i++) {
...
if (input50 == topic){
 String inString = "";
  for (int i=0;i<length;i++) {
     ...
     Serial.println("cmd_50(1)"); //Serial.print(inString); Serial.println(")");
